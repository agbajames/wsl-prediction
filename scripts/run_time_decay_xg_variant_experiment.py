#!/usr/bin/env python3
"""
Run offline time-decay and xG-weighting champion-family variant experiments.
...
from evaluation.time_decay_xg_variants import available_variant_names, run_time_decay_xg_variant_experiment
from scripts.run_model_comparison import load_match_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run local time-decay/xG variant experiment.")
