#!/usr/bin/env python3
"""
Run an offline champion draw-adjustment experiment.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run champion draw-adjustment experiment from local JSON.")
...
def main() -> None:
    ...
    summary = build_draw_adjustment_experiment(payload, champion_model=args.champion_model, top_n=args.top_n)
